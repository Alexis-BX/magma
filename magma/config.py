...
class MultimodalConfig:
    ...
    train_data: str = "/gpfs/alpine/csc499/proj-shared/LAION-400m-webdataset/data/{00000..37309}.tar"
    val_data: str = "/gpfs/alpine/csc499/proj-shared/LAION-400m-webdataset/data/{37309..41455}.tar"
    train_num_samples: int = 366598870
